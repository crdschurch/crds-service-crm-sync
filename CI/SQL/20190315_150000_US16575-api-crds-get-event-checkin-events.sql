...
/****** Object:  StoredProcedure [dbo].[api_crds_Get_Event_Checkin_Events]    Script Date: 1/7/2019 8:58:08 AM ******/
SET ANSI_NULLS ON
GO
...
-- add the proc and permissions to the mp db for 'api_crds_Get_Event_Checkin_Events'
IF NOT EXISTS(SELECT * FROM [dbo].[dp_API_Procedures] WHERE [procedure_name] = 'api_crds_Get_Event_Checkin_Events')
BEGIN	

	INSERT INTO [dbo].[dp_API_Procedures] ([procedure_name]) 
	OUTPUT INSERTED.API_Procedure_ID INTO @IDs
	VALUES('api_crds_Get_Event_Checkin_Events')
